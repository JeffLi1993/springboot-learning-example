...
import com.spring.springboot.result.ResultBody;
import com.spring.springboot.constant.CityErrorInfoEnum;
import com.spring.springboot.result.GlobalErrorInfoException;
...
public class ErrorJsonController {
    ...
    public ResultBody findOneCity(@RequestParam("cityName") String cityName) throws GlobalErrorInfoException {
        ...
        return new ResultBody(new City(1L,2L,"宝鸡","是我的故乡"));
    }
}